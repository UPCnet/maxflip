...
class MaxFlipTests(unittest.TestCase):
    ...
    def test_rename_key(self):
        ...
        self.assertEqual(collection[0]['name'], results.items[0].item['newname'])
    ...
    def test_rename_subkey(self):
        ...
        results.run()
        self.assertIn('name2', results.items[0].item['person'].keys())
        self.assertNotIn('surname', results.items[0].item['person'].keys())
    ...
    def test_rename_deep_subkey(self):
        ...
        results.run()
        self.assertIn('postal_code', results.items[0].item['person']['address'].keys())
        self.assertNotIn('cp', results.items[0].item['person']['address'].keys())
    ...
    def test_delete_multiple_keys(self):
        ...
        results.run()
        self.assertNotIn('name', results.items[0].item.keys())
        self.assertNotIn('nickname', results.items[0].item.keys())
    ...
    def test_delete_all_keys_except_one(self):
        ...
        results.run()
        self.assertEqual(['_id'], results.items[0].item.keys())
    ...
    def test_delete_all_keys_except_one_on_subkey(self):
        ...
        results.run()
        self.assertEqual(['name'], results.items[0].item['person'].keys())
    ...
    def test_set_key(self):
        ...
        results.run()
        self.assertEqual('vuit', results.items[0].item['number'])
    ...
    def test_set_deep_key(self):
        ...
        results.run()
        self.assertEqual('Locke', results.items[0].item['person']['surname'])
    ...
    def test_set_key_default_overwrite(self):
        ...
        results.run()
        self.assertEqual('Johnny', results.items[0].item['name'])
    ...
    def test_set_key_dont_overwrite(self):
        ...
        results.run()
        self.assertEqual('John', results.items[0].item['name'])
    ...
    def test_set_key_from_key(self):
        ...
        results.run()
        self.assertEqual(collection[0]['nickname'], results.items[0].item['name'])
    ...
    def test_set_key_from_deep_key(self):
        ...
        results.run()
        self.assertEqual(results.items[0].item['person']['name'], results.items[0].item['person']['nickname'])
    ...
    def test_subtask(self):
        ...
        results.run()
        self.assertIn('skill_name', results.items[0].item['person']['skills'][0].keys())
        self.assertNotIn('name', results.items[0].item['person']['skills'][0].keys())
